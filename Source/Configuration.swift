...
public struct Configuration
    ...
    */
    public mutating func beforeStartingRequest<T>(callback: (Resource<T>,Request<T>) -> Void)
        { beforeStartingRequestCallbacks.append(callback) }
    
    internal var beforeStartingRequestCallbacks: [(AnyResource,AnyRequest) -> Void] = []
